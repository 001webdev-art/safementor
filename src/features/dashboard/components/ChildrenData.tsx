                                        ...
                                        <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                                ...
                                                <div className="flex gap-2">
                                                    <Select
                                                        label={t('fields.birthMonth')}
                                                        selectedKeys={[String(draft.birth_month ?? child.birth_month ?? 1)]}
                                                        onChange={(e) => updateChildField(child.id, 'birth_month', Number(e.target.value))}
                                                        size="sm"
                                                        variant="bordered"
                                                        classNames={{
                                                    ...
                                                    >
                                                        {Array.from({ length: 12 }, (_, i) => i + 1).map((m) => (
                                                            <SelectItem key={String(m)} value={m}>
                                                    ...
                                                    <Select
                                                        ...
                                                        selectedKeys={[String(draft.birth_year ?? child.birth_year ?? 2022)]}
                                                        onChange={(e) => updateChildField(child.id, 'birth_year', Number(e.target.value))}
                                                        size="sm"
                                                        variant="bordered"
                                                        classNames={{
                                                            trigger: "border-gray-300 hover:border-[#889A7F] focus:border-[#889A7F]"
                                                    ...
                                                    >
                                                        {Array.from({ length: 26 }, (_, i) => 2010 + i).map((y) => (
                                                            <SelectItem key={String(y)} value={y}>
                                                                {String(y)}
                                                            </SelectItem>
                                                        ))}
                                                    </Select>
