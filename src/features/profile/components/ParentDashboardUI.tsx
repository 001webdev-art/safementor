...
import { ParentService, AuthService, Child, SafetyAlert, EmotionTrend, ChatMessage } from '@/app/api';
import { LineChart, Line, XAxis, YAxis, Tooltip, ResponsiveContainer, CartesianGrid } from 'recharts';

import ChildWelcome from '@/features/chat/components/screens/WelcomeSection';
import { ChatScreen as ChildChatScreen } from '@/features/chat/components/screens/ChatScreen';
import { HelpScreen as ChildHelp } from '@/features/chat/components/screens/HelpScreen';
import { ExitScreen as ChildExit } from '@/features/chat/components/screens/ExitScreen';
...
const ChildPreviewPage = ({ onNewAlert }: { onNewAlert?: () => void }) => {
  ...
  const renderScreen = () => {
    switch(activeScreen) {
      ...
      case 'chat': return <ChildChatScreen onNavigate={(screen) => setActiveScreen(screen.replace('child-', '') as any)} />;
